...
export const AuthModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 transition-opacity">
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl bg-black border border-white/15 shadow-2xl shadow-emerald-500/10">
        {/* Cabecera en blanco y negro */}
        <div className="relative p-6 pb-4 border-b border-white/10 bg-white/[0.02]">
          <button
          ...
          <div className="flex items-center gap-2 text-emerald-400 mb-1.5 font-semibold text-xs tracking-wider uppercase">
        ...
        {/* Pestañas en blanco y negro */}
        <div className="grid grid-cols-2 gap-1 p-1.5 bg-neutral-950 border-b border-white/10">
          <button
            type="button"
            onClick={() => {
              setTab('login');
